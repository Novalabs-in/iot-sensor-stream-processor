...
High-throughput sensor telemetry stream processor featuring rolling average filters.
...
1. Clone this repository under your workspace:
   ```bash
   git clone https://github.com/Novalabs-in/iot-sensor-stream-processor.git
   cd iot-sensor-stream-processor
   ```
